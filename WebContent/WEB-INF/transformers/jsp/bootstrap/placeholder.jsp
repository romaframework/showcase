...
%>
<div id="<%=JaniculumWrapper.id(component, null)%>" class="row-fluid <%=JaniculumWrapper.cssClass(component, "placeholder", null)%>" style="<%=JaniculumWrapper.inlineStyle(component, null)%>">
